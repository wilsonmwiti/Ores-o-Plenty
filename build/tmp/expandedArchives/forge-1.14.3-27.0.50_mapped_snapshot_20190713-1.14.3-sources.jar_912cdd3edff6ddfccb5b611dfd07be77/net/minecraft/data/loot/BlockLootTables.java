...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   private static LootTable.Builder func_218546_a(IItemProvider p_218546_0_) {
      return LootTable.builder().func_216040_a(func_218560_a(p_218546_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218546_0_))));
   }
   ...
   private static LootTable.Builder func_218494_a(Block p_218494_0_, ILootCondition.IBuilder p_218494_1_, LootEntry.Builder<?> p_218494_2_) {
      return LootTable.builder().func_216040_a(LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(((StandaloneLootEntry.Builder)ItemLootEntry.builder(p_218494_0_).acceptCondition(p_218494_1_)).func_216080_a(p_218494_2_)));
   }
   ...
   private static LootTable.Builder func_218463_a(IItemProvider p_218463_0_, IRandomRange p_218463_1_) {
      return LootTable.builder().func_216040_a(LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(func_218552_a(p_218463_0_, ItemLootEntry.builder(p_218463_0_).acceptFunction(SetCount.func_215932_a(p_218463_1_)))));
   }
   ...
   private static LootTable.Builder func_218561_b(IItemProvider p_218561_0_) {
      return LootTable.builder().func_216040_a(LootPool.builder().acceptCondition(field_218573_a).rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218561_0_)));
   }

   private static LootTable.Builder func_218523_c(IItemProvider p_218523_0_) {
      return LootTable.builder().func_216040_a(func_218560_a(Blocks.FLOWER_POT, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(Blocks.FLOWER_POT)))).func_216040_a(func_218560_a(p_218523_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218523_0_))));
   }

   private static LootTable.Builder func_218513_d(Block p_218513_0_) {
      return LootTable.builder().func_216040_a(LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(func_218552_a(p_218513_0_, ItemLootEntry.builder(p_218513_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(2)).acceptCondition(BlockStateProperty.builder(p_218513_0_).with(SlabBlock.TYPE, SlabType.DOUBLE))))));
   }
   ...
   private static <T extends Comparable<T>> LootTable.Builder func_218562_a(Block p_218562_0_, IProperty<T> p_218562_1_, T p_218562_2_) {
      return LootTable.builder().func_216040_a(func_218560_a(p_218562_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218562_0_).acceptCondition(BlockStateProperty.builder(p_218562_0_).with(p_218562_1_, p_218562_2_)))));
   }

   private static LootTable.Builder func_218481_e(Block p_218481_0_) {
      return LootTable.builder().func_216040_a(func_218560_a(p_218481_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218481_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)))));
   }

   private static LootTable.Builder func_218544_f(Block p_218544_0_) {
      return LootTable.builder().func_216040_a(func_218560_a(p_218544_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218544_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Lock", "BlockEntityTag.Lock").func_216056_a("LootTable", "BlockEntityTag.LootTable").func_216056_a("LootTableSeed", "BlockEntityTag.LootTableSeed")).acceptFunction(SetContents.func_215920_b().func_216075_a(DynamicLootEntry.func_216162_a(ShulkerBoxBlock.field_220169_b))))));
   }

   private static LootTable.Builder func_218559_g(Block p_218559_0_) {
      return LootTable.builder().func_216040_a(func_218560_a(p_218559_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218559_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Patterns", "BlockEntityTag.Patterns")))));
   }
   ...
   private static LootTable.Builder func_218541_a(Block p_218541_0_, Item p_218541_1_, Item p_218541_2_, ILootCondition.IBuilder p_218541_3_) {
      return func_218552_a(p_218541_0_, LootTable.builder().func_216040_a(LootPool.builder().addEntry(((StandaloneLootEntry.Builder)ItemLootEntry.builder(p_218541_1_).acceptCondition(p_218541_3_)).func_216080_a(ItemLootEntry.builder(p_218541_2_)))).func_216040_a(LootPool.builder().acceptCondition(p_218541_3_).addEntry(ItemLootEntry.builder(p_218541_2_).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))));
   }
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      this.registerLootTable(Blocks.COCOA, (p_218478_0_) -> {
         return LootTable.builder().func_216040_a(LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(func_218552_a(p_218478_0_, ItemLootEntry.builder(Items.COCOA_BEANS).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(3)).acceptCondition(BlockStateProperty.builder(p_218478_0_).with(CocoaBlock.AGE, 2))))));
      });
      this.registerLootTable(Blocks.SEA_PICKLE, (p_218551_0_) -> {
         return LootTable.builder().func_216040_a(LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(func_218552_a(p_218551_0_, ItemLootEntry.builder(p_218551_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(2)).acceptCondition(BlockStateProperty.builder(p_218551_0_).with(SeaPickleBlock.PICKLES, 2))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(3)).acceptCondition(BlockStateProperty.builder(p_218551_0_).with(SeaPickleBlock.PICKLES, 3))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(4)).acceptCondition(BlockStateProperty.builder(p_218551_0_).with(SeaPickleBlock.PICKLES, 4))))));
      });
      this.registerLootTable(Blocks.COMPOSTER, (p_218565_0_) -> {
         return LootTable.builder().func_216040_a(LootPool.builder().addEntry(func_218552_a(p_218565_0_, ItemLootEntry.builder(Items.COMPOSTER)))).func_216040_a(LootPool.builder().addEntry(ItemLootEntry.builder(Items.BONE_MEAL)).acceptCondition(BlockStateProperty.builder(p_218565_0_).with(ComposterBlock.field_220298_a, 8)));
      });
      ...
      this.registerLootTable(Blocks.PLAYER_HEAD, (p_218473_0_) -> {
         return LootTable.builder().func_216040_a(func_218560_a(p_218473_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(p_218473_0_).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Owner", "SkullOwner")))));
      });
      ...
      this.registerLootTable(Blocks.CARROTS, (p_218542_1_) -> {
         return func_218552_a(p_218542_1_, LootTable.builder().func_216040_a(LootPool.builder().addEntry(ItemLootEntry.builder(Items.CARROT))).func_216040_a(LootPool.builder().acceptCondition(ilootcondition$ibuilder2).addEntry(ItemLootEntry.builder(Items.CARROT).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))));
      });
      ...
      this.registerLootTable(Blocks.POTATOES, (p_218563_1_) -> {
         return func_218552_a(p_218563_1_, LootTable.builder().func_216040_a(LootPool.builder().addEntry(ItemLootEntry.builder(Items.POTATO))).func_216040_a(LootPool.builder().acceptCondition(ilootcondition$ibuilder3).addEntry(ItemLootEntry.builder(Items.POTATO).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))).func_216040_a(LootPool.builder().acceptCondition(ilootcondition$ibuilder3).addEntry(ItemLootEntry.builder(Items.POISONOUS_POTATO).acceptCondition(RandomChance.builder(0.02F)))));
      });
      this.registerLootTable(Blocks.SWEET_BERRY_BUSH, (p_218554_0_) -> {
         return func_218552_a(p_218554_0_, LootTable.builder().func_216040_a(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).with(SweetBerryBushBlock.AGE, 3)).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 3.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))).func_216040_a(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).with(SweetBerryBushBlock.AGE, 2)).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(1.0F, 2.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.CHORUS_FLOWER, (p_218464_0_) -> {
         return LootTable.builder().func_216040_a(LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(func_218560_a(p_218464_0_, ItemLootEntry.builder(p_218464_0_)).acceptCondition(EntityHasProperty.func_215998_a(LootContext.EntityTarget.THIS))));
      });
      ...
      this.registerLootTable(Blocks.NETHER_WART, (p_218469_0_) -> {
         return LootTable.builder().func_216040_a(func_218552_a(p_218469_0_, LootPool.builder().rolls(ConstantRange.func_215835_a(1)).addEntry(ItemLootEntry.builder(Items.NETHER_WART).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 4.0F)).acceptCondition(BlockStateProperty.builder(p_218469_0_).with(NetherWartBlock.AGE, 3))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE).acceptCondition(BlockStateProperty.builder(p_218469_0_).with(NetherWartBlock.AGE, 3))))));
      });
      this.registerLootTable(Blocks.SNOW, (p_218508_0_) -> {
         return LootTable.builder().func_216040_a(LootPool.builder().acceptCondition(EntityHasProperty.func_215998_a(LootContext.EntityTarget.THIS)).addEntry(AlternativesLootEntry.func_216149_a(AlternativesLootEntry.func_216149_a(ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 1)), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 2))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(2))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 3))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(3))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 4))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(4))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 5))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(5))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 6))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(6))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 7))).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(7))), ItemLootEntry.builder(Items.SNOWBALL).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(8)))).acceptCondition(field_218574_b), AlternativesLootEntry.func_216149_a(ItemLootEntry.builder(p_218508_0_).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 1)), ItemLootEntry.builder(p_218508_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(2))).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 2)), ItemLootEntry.builder(p_218508_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(3))).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 3)), ItemLootEntry.builder(p_218508_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(4))).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 4)), ItemLootEntry.builder(p_218508_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(5))).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 5)), ItemLootEntry.builder(p_218508_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(6))).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 6)), ItemLootEntry.builder(p_218508_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(7))).acceptCondition(BlockStateProperty.builder(p_218508_0_).with(SnowBlock.LAYERS, 7)), ItemLootEntry.builder(Blocks.SNOW_BLOCK)))));
      });
      ...
      this.registerLootTable(Blocks.CAMPFIRE, (p_218484_0_) -> {
         return func_218519_a(p_218484_0_, func_218560_a(p_218484_0_, ItemLootEntry.builder(Items.CHARCOAL).acceptFunction(SetCount.func_215932_a(ConstantRange.func_215835_a(2)))));
      });
