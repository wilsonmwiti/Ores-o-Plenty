...
public class CookingRecipeBuilder {
   ...
   public void func_218635_a(Consumer<IFinishedRecipe> p_218635_1_, ResourceLocation p_218635_2_) {
      ...
      this.field_218640_e.withParentId(new ResourceLocation("recipes/root")).withCriterion("has_the_recipe", new RecipeUnlockedTrigger.Instance(p_218635_2_)).withRewards(AdvancementRewards.Builder.recipe(p_218635_2_)).withRequirementsStrategy(IRequirementsStrategy.OR);
