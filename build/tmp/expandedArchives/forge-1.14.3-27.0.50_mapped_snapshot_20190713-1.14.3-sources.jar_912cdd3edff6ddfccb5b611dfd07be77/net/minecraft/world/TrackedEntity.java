...
public class TrackedEntity {
   ...
   public void untrack(ServerPlayerEntity p_219454_1_) {
      ...
      net.minecraftforge.event.ForgeEventFactory.onStopEntityTracking(this.trackedEntity, p_219454_1_);
   }
   ...
   public void track(ServerPlayerEntity p_219455_1_) {
      ...
      net.minecraftforge.event.ForgeEventFactory.onStartEntityTracking(this.trackedEntity, p_219455_1_);
   }
   ...
   private void updateEncodedPosition() {
      this.encodedPosX = SEntityPacket.func_218743_a(this.trackedEntity.posX);
      this.encodedPosY = SEntityPacket.func_218743_a(this.trackedEntity.posY);
      this.encodedPosZ = SEntityPacket.func_218743_a(this.trackedEntity.posZ);
   }
