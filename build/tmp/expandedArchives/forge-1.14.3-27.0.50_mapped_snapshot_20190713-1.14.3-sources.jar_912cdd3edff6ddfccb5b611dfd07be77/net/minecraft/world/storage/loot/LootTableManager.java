...
public class LootTableManager extends JsonReloadListener {
   ...
   protected void apply(Map<ResourceLocation, JsonObject> splashList, IResourceManager resourceManagerIn, IProfiler profilerIn) {
      ...
      JsonObject jsonobject = splashList.remove(LootTables.EMPTY);
      if (jsonobject != null) {
      ...
      splashList.forEach((p_223385_1_, p_223385_2_) -> {
         try {
            net.minecraft.resources.IResource res = resourceManagerIn.getResource(getPreparedPath(p_223385_1_));
   ...
   public static void func_215302_a(ValidationResults p_215302_0_, ResourceLocation p_215302_1_, LootTable p_215302_2_, Function<ResourceLocation, LootTable> p_215302_3_) {
      ...
      p_215302_2_.func_216117_a(p_215302_0_.descend("{" + p_215302_1_.toString() + "}"), p_215302_3_, set, p_215302_2_.getParameterSet());
   }
