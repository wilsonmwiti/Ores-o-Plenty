...
public abstract class ChunkGenerator<C extends GenerationSettings> {
         ...
         for(int i1 = k - 8; i1 <= k + 8; ++i1) {
            ...
            while(listiterator.hasNext()) {
               ...
               if (configuredcarver.shouldCarve(sharedseedrandom, l, i1)) {
                  configuredcarver.carve(p_222538_1_, sharedseedrandom, this.getSeaLevel(), l, i1, j, k, bitset);
               }
            }
         }
      }
   ...
   public abstract void makeBase(IWorld p_222537_1_, IChunk p_222537_2_);
