...
public class CartographyTableScreen extends ContainerScreen<CartographyContainer> {
   ...
   private void func_214108_a(@Nullable MapData p_214108_1_, int p_214108_2_, int p_214108_3_, float p_214108_4_) {
      if (p_214108_1_ != null) {
         GlStateManager.pushMatrix();
         GlStateManager.translatef((float)p_214108_2_, (float)p_214108_3_, 1.0F);
         GlStateManager.scalef(p_214108_4_, p_214108_4_, 1.0F);
         this.minecraft.gameRenderer.getMapItemRenderer().renderMap(p_214108_1_, true);
         GlStateManager.popMatrix();
      }
