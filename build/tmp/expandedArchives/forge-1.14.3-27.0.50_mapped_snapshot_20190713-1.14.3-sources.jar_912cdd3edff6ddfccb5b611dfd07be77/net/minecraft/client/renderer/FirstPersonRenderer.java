...
public class FirstPersonRenderer {
   ...
   private void renderArm(HandSide side) {
      ...
      EntityRenderer<AbstractClientPlayerEntity> entityrenderer = this.renderManager.getRenderer(this.mc.player);
   ...
   private void renderArmFirstPerson(float equippedProgress, float swingProgress, HandSide side) {
      ...
      PlayerRenderer playerrenderer = this.renderManager.getRenderer(abstractclientplayerentity);
      GlStateManager.disableCull();
      if (flag) {
   ...
   public void renderOverlays(float partialTicks) {
      ...
      if (this.mc.player.isEntityInsideOpaqueBlock()) {
         ...
         if (blockstate.getRenderType() != BlockRenderType.INVISIBLE) {
            ...
            this.renderSuffocationOverlay(this.mc.getBlockRendererDispatcher().getBlockModelShapes().getTexture(blockstate, mc.world, overlayPos));
         }
      }
