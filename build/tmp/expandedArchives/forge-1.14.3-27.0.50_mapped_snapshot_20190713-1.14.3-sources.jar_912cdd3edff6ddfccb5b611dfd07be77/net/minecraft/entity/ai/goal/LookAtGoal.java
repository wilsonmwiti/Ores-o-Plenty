   ...
   public boolean shouldExecute() {
      if (this.entity.getRNG().nextFloat() >= this.chance) {
         ...
         if (this.watchedClass == PlayerEntity.class) {
            ...
            this.closestEntity = this.entity.world.getClosestEntityWithinAABB(this.watchedClass, this.field_220716_e, this.entity, this.entity.posX, this.entity.posY + (double)this.entity.getEyeHeight(), this.entity.posZ, this.entity.getBoundingBox().grow((double)this.maxDistance, 3.0D, (double)this.maxDistance));
         }
