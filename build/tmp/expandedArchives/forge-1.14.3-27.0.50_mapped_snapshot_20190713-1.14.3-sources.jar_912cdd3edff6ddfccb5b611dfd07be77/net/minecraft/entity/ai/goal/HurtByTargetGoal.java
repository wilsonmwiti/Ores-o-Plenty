...
public class HurtByTargetGoal extends TargetGoal {
   ...
   protected void alertOthers() {
      ...
      List<MobEntity> list = this.goalOwner.world.getEntitiesWithinAABB(this.goalOwner.getClass(), (new AxisAlignedBB(this.goalOwner.posX, this.goalOwner.posY, this.goalOwner.posZ, this.goalOwner.posX + 1.0D, this.goalOwner.posY + 1.0D, this.goalOwner.posZ + 1.0D)).grow(d0, 10.0D, d0));
