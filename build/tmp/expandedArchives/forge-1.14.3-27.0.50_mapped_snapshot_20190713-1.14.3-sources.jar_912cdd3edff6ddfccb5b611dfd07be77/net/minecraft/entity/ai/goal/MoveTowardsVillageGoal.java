...
public class MoveTowardsVillageGoal extends RandomWalkingGoal {
   ...
   protected Vec3d getPosition() {
      ...
      if (sectionpos1 != sectionpos) {
         ...
         return RandomPositionGenerator.findRandomTargetBlockTowards(this.creature, 10, 7, new Vec3d((double)blockpos1.getX(), (double)blockpos1.getY(), (double)blockpos1.getZ()));
      } else {
         return null;
      }
   }
