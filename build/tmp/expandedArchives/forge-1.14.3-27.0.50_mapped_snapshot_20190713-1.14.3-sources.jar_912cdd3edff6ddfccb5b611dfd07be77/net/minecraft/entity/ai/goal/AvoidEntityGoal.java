...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
   ...
   public boolean shouldExecute() {
      this.field_75376_d = this.entity.world.getClosestEntityWithinAABB(this.classToAvoid, this.field_220872_k, this.entity, this.entity.posX, this.entity.posY, this.entity.posZ, this.entity.getBoundingBox().grow((double)this.avoidDistance, 3.0D, (double)this.avoidDistance));
