...
public abstract class PlayerEntity extends LivingEntity {
   ...
   private void func_213824_a(IParticleData p_213824_1_) {
      for(int i = 0; i < 5; ++i) {
         ...
         this.world.addParticle(p_213824_1_, this.posX + (double)(this.rand.nextFloat() * this.getWidth() * 2.0F) - (double)this.getWidth(), this.posY + 1.0D + (double)(this.rand.nextFloat() * this.getHeight()), this.posZ + (double)(this.rand.nextFloat() * this.getWidth() * 2.0F) - (double)this.getWidth(), d0, d1, d2);
      }
   ...
   public ItemEntity dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem) {
      if (droppedItem.isEmpty()) {
         ...
         if (dropAround) {
            ...
            this.setMotion((double)(-MathHelper.sin(f1) * f), (double)0.2F, (double)(MathHelper.cos(f1) * f));
         } else {
            float f7 = 0.3F;
   ...
   protected void damageEntity(DamageSource damageSrc, float damageAmount) {
      if (!this.isInvulnerableTo(damageSrc)) {
         ...
         if (f1 > 0.0F && f1 < 3.4028235E37F) {
            this.addStat(Stats.DAMAGE_ABSORBED, Math.round(f1 * 10.0F));
         }
         ...
         if (damageAmount != 0.0F) {
            ...
            if (damageAmount < 3.4028235E37F) {
               this.addStat(Stats.DAMAGE_TAKEN, Math.round(damageAmount * 10.0F));
            }
            ...
            if (f > 0.0F || f1 > 0.0F) {
               ...
               if (flag5) {
                  ...
                  if (flag3) {
                     ...
                     this.world.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_PLAYER_ATTACK_SWEEP, this.getSoundCategory(), 1.0F, 1.0F);
                  ...
                  if (flag2) {
                     this.world.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_PLAYER_ATTACK_CRIT, this.getSoundCategory(), 1.0F, 1.0F);
                     this.onCriticalHit(targetEntity);
                  }

                  if (!flag2 && !flag3) {
                     if (flag) {
                        this.world.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_PLAYER_ATTACK_STRONG, this.getSoundCategory(), 1.0F, 1.0F);
                     } else {
                        this.world.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_PLAYER_ATTACK_WEAK, this.getSoundCategory(), 1.0F, 1.0F);
                     }
                  }
                  ...
                  this.world.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_PLAYER_ATTACK_NODAMAGE, this.getSoundCategory(), 1.0F, 1.0F);
                  if (flag4) {
   ...
   public void spawnSweepParticles() {
      ...
      if (this.world instanceof ServerWorld) {
         ((ServerWorld)this.world).spawnParticle(ParticleTypes.SWEEP_ATTACK, this.posX + d0, this.posY + (double)this.getHeight() * 0.5D, this.posZ + d1, 0, d0, 0.0D, d1, 0.0D);
      }
   ...
   public Either<PlayerEntity.SleepResult, Unit> trySleep(BlockPos at) {
      PlayerEntity.SleepResult ret = net.minecraftforge.event.ForgeEventFactory.onPlayerSleepInBed(this, getBedPosition());
      ...
      if (!this.world.isRemote) {
         ...
         if (!net.minecraftforge.event.ForgeEventFactory.fireSleepingTimeCheck(this, getBedPosition())) {
   ...
   public void wakeUpPlayer(boolean immediately, boolean updateWorldFlag, boolean setSpawn) {
      ...
      Optional<BlockPos> optional = this.getBedPosition();
      super.wakeUp();
      ...
      if (setSpawn) {
         optional.ifPresent((p_213825_1_) -> {
            this.setSpawnPoint(p_213825_1_, false);
         });
      }
   ...
   protected boolean isNormalCube(BlockPos pos) {
      return !this.world.getBlockState(pos).causesSuffocation(this.world, pos);
   }
   ...
   private void spawnShoulderEntity(@Nullable CompoundNBT p_192026_1_) {
      if (!this.world.isRemote && !p_192026_1_.isEmpty()) {
         EntityType.loadEntityUnchecked(p_192026_1_, this.world).ifPresent((p_213827_1_) -> {
            if (p_213827_1_ instanceof TameableEntity) {
               ((TameableEntity)p_213827_1_).setOwnerId(this.entityUniqueID);
            }

            p_213827_1_.setPosition(this.posX, this.posY + (double)0.7F, this.posZ);
            ((ServerWorld)this.world).summonEntity(p_213827_1_);
         });
      }
   ...
   public ItemStack onFoodEaten(World p_213357_1_, ItemStack p_213357_2_) {
      ...
      p_213357_1_.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_PLAYER_BURP, SoundCategory.PLAYERS, 0.5F, p_213357_1_.rand.nextFloat() * 0.1F + 0.9F);
