...
public class EnderDragonEntity extends MobEntity implements IMob {
   ...
   public final EnderDragonPartEntity dragonPartNeck;
   ...
   public void livingTick() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         this.world.addParticle(ParticleTypes.EXPLOSION, this.posX + (double)f11, this.posY + 2.0D + (double)f13, this.posZ + (double)f14, 0.0D, 0.0D, 0.0D);
      } else {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.world.isRemote) {
               ...
               if (vec3d != null) {
                  ...
                  Vec3d vec3d1 = vec3d.subtract(this.posX, this.posY, this.posZ).normalize();
                  Vec3d vec3d2 = (new Vec3d((double)MathHelper.sin(this.rotationYaw * ((float)Math.PI / 180F)), this.getMotion().y, (double)(-MathHelper.cos(this.rotationYaw * ((float)Math.PI / 180F))))).normalize();
                  float f8 = Math.max(((float)vec3d2.dotProduct(vec3d1) + 0.5F) / 1.5F, 0.0F);
                  this.randomYawVelocity *= 0.8F;
                  this.randomYawVelocity = (float)((double)this.randomYawVelocity + d5 * (double)iphase.getYawFactor());
                  this.rotationYaw += this.randomYawVelocity * 0.1F;
                  float f9 = (float)(2.0D / (d3 + 1.0D));
                  float f10 = 0.06F;
                  this.moveRelative(0.06F * (f8 * f9 + (1.0F - f9)), new Vec3d(0.0D, 0.0D, -1.0D));
                  if (this.slowed) {
            ...
            for(int j = 0; j < this.field_70977_g.length; ++j) {
               avec3d[j] = new Vec3d(this.field_70977_g[j].posX, this.field_70977_g[j].posY, this.field_70977_g[j].posZ);
            }
            ...
            this.field_70987_i.tick();
            this.field_70987_i.setLocationAndAngles(this.posX + (double)(f3 * 0.5F), this.posY, this.posZ - (double)(f18 * 0.5F), 0.0F, 0.0F);
            this.field_70983_bA.tick();
            this.field_70983_bA.setLocationAndAngles(this.posX + (double)(f18 * 4.5F), this.posY + 2.0D, this.posZ + (double)(f3 * 4.5F), 0.0F, 0.0F);
            this.field_70990_bB.tick();
            this.field_70990_bB.setLocationAndAngles(this.posX - (double)(f18 * 4.5F), this.posY + 2.0D, this.posZ - (double)(f3 * 4.5F), 0.0F, 0.0F);
            ...
            this.field_70986_h.tick();
            this.dragonPartNeck.tick();
            float f20 = this.getHeadYOffset(1.0F);
            this.field_70986_h.setLocationAndAngles(this.posX + (double)(f19 * 6.5F * f16), this.posY + (double)f20 + (double)(f2 * 6.5F), this.posZ - (double)(f4 * 6.5F * f16), 0.0F, 0.0F);
            ...
            for(int k = 0; k < 3; ++k) {
               ...
               enderdragonpartentity.setLocationAndAngles(this.posX - (double)((f3 * 1.5F + f6 * f23) * f16), this.posY + (adouble1[1] - adouble[1]) - (double)((f23 + 1.5F) * f2) + 1.5D, this.posZ + (double)((f18 * 1.5F + f22 * f23) * f16), 0.0F, 0.0F);
            }
   ...
   private void dropExperience(int p_184668_1_) {
      while(p_184668_1_ > 0) {
         ...
         p_184668_1_ -= i;
         this.world.addEntity(new ExperienceOrbEntity(this.world, this.posX, this.posY, this.posZ, i));
      }
