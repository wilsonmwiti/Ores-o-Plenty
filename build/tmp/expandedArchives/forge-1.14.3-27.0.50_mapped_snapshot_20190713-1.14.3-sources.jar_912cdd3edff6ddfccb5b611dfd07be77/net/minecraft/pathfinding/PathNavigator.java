...
public abstract class PathNavigator {
   ...
   public Path getPathToPos(BlockPos pos) {
      ...
      return this.getPath(pos, (double)f, (double)f1, (double)f2, 8, false);
   }
   ...
   public Path getPathToEntityLiving(Entity entityIn) {
      ...
      return this.getPath(blockpos, d0, d1, d2, 16, true);
   }

   @Nullable
   protected Path getPath(BlockPos pos, double x, double y, double z, int extraSearchDistance, boolean isPathToEntity) {
      if (this.entity.posY < 0.0D) {
         ...
         BlockPos blockpos = isPathToEntity ? (new BlockPos(this.entity)).up() : new BlockPos(this.entity);
         int i = (int)(f + (float)extraSearchDistance);
         IWorldReader iworldreader = new Region(this.world, blockpos.add(-i, -i, -i), blockpos.add(i, i, i));
         Path path = this.pathFinder.findPath(iworldreader, this.entity, x, y, z, f);
