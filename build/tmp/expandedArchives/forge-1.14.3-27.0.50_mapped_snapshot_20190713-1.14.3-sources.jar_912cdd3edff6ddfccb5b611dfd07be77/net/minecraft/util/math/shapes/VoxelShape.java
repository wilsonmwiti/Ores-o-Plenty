...
public abstract class VoxelShape {
   ...
   public void forEachBox(VoxelShapes.ILineConsumer action) {
      this.part.forEachBox((p_197765_2_, p_197765_3_, p_197765_4_, p_197765_5_, p_197765_6_, p_197765_7_) -> {
         action.consume(this.getValueUnchecked(Direction.Axis.X, p_197765_2_), this.getValueUnchecked(Direction.Axis.Y, p_197765_3_), this.getValueUnchecked(Direction.Axis.Z, p_197765_4_), this.getValueUnchecked(Direction.Axis.X, p_197765_5_), this.getValueUnchecked(Direction.Axis.Y, p_197765_6_), this.getValueUnchecked(Direction.Axis.Z, p_197765_7_));
      }, true);
   }
